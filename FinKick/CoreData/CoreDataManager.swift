...
class CoreDataManager {
    ...
    func saveUser(id: String, email: String,
                  pw: String, onSuccess: @escaping ((Bool) -> Void)) {
        if let context = context,
    ...
    func deleteUser(id: String, onSuccess: @escaping ((Bool) -> Void)) {
...
extension CoreDataManager {
    fileprivate func filteredRequest(id: String) -> NSFetchRequest<NSFetchRequestResult> {
